    ...
    with blankbc:
        ...
        if fill_pdf_button:
            ...
            font_sizes = {
                ...
                "ODOMETER READING": 10,
                "Owner 1 ID": 10,
                "Full Legal Name of Owner 1 First Middle Last Suffix or Company Name": 7,
                "Owner 2 ID": 10,
                "Full Legal Name of Owner 2 First Middle Last Suffix or Company Name": 7,
                "Residence Address Individual Business Address Firm City and State Zip Code": 7,
                "Mail Address if different from above City and State Zip Code": 10,
                "Vehicle Location Address if different from residence address above City and State Zip Code": 7,
                "Tax County": 10,
                "Date 1": 10,
                "Lienholder 1 ID": 10,
                "Lienholder 1 name": 6,
