...
with finance:
    ...
    with sc:
        ...
        st.markdown('<input class="label-input" type="text" value="Cost" disabled>', unsafe_allow_html=True)
        veh_cost = fc6.number_input(label="Cost", key="veh_cost", value = None, placeholder="Cost", label_visibility='collapsed', help="Cost")
        st.markdown('<input class="label-input" type="text" value="Book Value" disabled>', unsafe_allow_html=True)
